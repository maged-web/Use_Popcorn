...
StarRating.propTypes = {
    ...
    siza: PropTypes.number,
    messeges: PropTypes.array,
    className: PropTypes.string,
    onSetRating: PropTypes.func
}

export default function StarRating({ maxRating = 5, color = '#fcc419', size = 48, messeges = [], defaultRating = 0, onSetRating }) {
    ...
    return (
        <div style={containerStyle}>
            ...
            <p style={textStyle}>{messeges.length === maxRating ? messeges[tempRating ? tempRating - 1 : rating - 1] : tempRating || rating || ""}</p>
        </div>
    )
}
